      ...
      <div className="d">
        ...
        <div className="section">
          ...
          <div className="text-container">
            {(windowWidth <= 900 || !isVisitPage) && <Arrow inverted={true} />}
            <h2>
          ...
          <div className="text-container">
            ...
            >
              ...
              <span class="ada-tooltip" id="tooltip-non-accessible">
                This entrance is a staircase. For ramp access, use the Noble St.
                entrance.
              </span>
            </button>
            <p>
              Between 11th & 12th St.{" "}
              <a href="https://maps.google.com/..." className="directions-link">
                Get Directions
              </a>
            </p>
          </div>
